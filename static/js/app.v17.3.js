        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.enable_query) {
                    ...
                    // SAFETY FIX: Re-query button if reference is lost
                    if (!this.askQuestionsBtn) {
                        this.askQuestionsBtn = document.getElementById('askQuestionsBtn');
                        console.log('⚠️ Re-queried button reference:', this.askQuestionsBtn);
                    }
                    ...
                    if (this.askQuestionsBtn) {
                        ...
                        console.error('❌ Button element still not found after re-query!');
                    }
                } else {
    ...
    async startForwardEngineering() {
        try {
            ...
            if (data.success) {
                ...
                // FIXED: Enable query button if database is available (like uploadFile does)
                if (data.enable_query) {
                    this.queryEnabled = true;
                    ...
                    if (this.askQuestionsBtn) {
                        this.askQuestionsBtn.style.display = 'block';
                        console.log('✅ Query feature enabled for forward engineering!');
                        console.log('   Button display:', this.askQuestionsBtn.style.display);
                        console.log('   Button element:', this.askQuestionsBtn);
                    ...
                    console.log('⚠️  Query not enabled - enable_query flag is false or missing');
                }
            } else {
